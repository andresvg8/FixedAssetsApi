...
public class FixedAssetRestController {
    ...
    @GetMapping(params = {"purchaseDate"})
    ...
    public ResponseEntity<?> updateFixedAsset(
        ...
        if(fixedAsset.getId()==null){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("The given asset sshould have an id number.");
        }
    ...
    public ResponseEntity<?> setDefaultValues(){
        try{
